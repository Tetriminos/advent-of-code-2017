...
let memoryBankThatNeedsToBeRepeated = [storedMemoryBanks[storedMemoryBanks.length-1]];
console.log(memoryBankThatNeedsToBeRepeated);
newCycles = 0;
...
while (true) {
    ...
    // console.log(memoryBanks);
    newCycles++;
    if (checkIfAlreadySeen(memoryBanks, memoryBankThatNeedsToBeRepeated) === true) {
