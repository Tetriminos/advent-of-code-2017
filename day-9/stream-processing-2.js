...
console.log(`################
      DONE    
################`);
console.log(JSON.stringify(groupsByLevel, undefined, 4));

let sum = 0;
for (let i = 0; i < groupsByLevel.length; i++) {
    for (let j in groupsByLevel[i]) {
        console.log(i + 1);
        sum += i + 1;
    }
}
...
console.log('removed garbage count: ' + removedGarbageCounter);